...
class Announcement(Base):
    ...
    submissions: Mapped[List["Submission"]] = relationship(
        "Submission", back_populates="linked_announcement", foreign_keys="Submission.linked_announcement_id"
    )
...
class AnnouncementFile(Base):
    ...
    # Relationships
    announcement: Mapped["Announcement"] = relationship("Announcement", back_populates="files")
